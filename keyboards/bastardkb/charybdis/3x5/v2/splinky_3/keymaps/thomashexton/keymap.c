...
#include "print.h"  // Include the print functionality for debugging

/* ────────────────────────────────────────────────────────────────────────── *
 *  KEYBOARD CONFIGURATION AND DEFINITIONS
 * ────────────────────────────────────────────────────────────────────────── */
...
const uint16_t PROGMEM o_paren_combo[]       = {_L_PTR(KC_H), COMMA_KEY, COMBO_END};  // Using our custom comma keycode
const uint16_t PROGMEM c_paren_combo[]       = {COMMA_KEY, DOT_KEY, COMBO_END};       // Using our custom keycodes
const uint16_t PROGMEM o_angle_combo[]       = {KC_K, _L_PTR(KC_H), COMBO_END};
const uint16_t PROGMEM c_angle_combo[]       = {DOT_KEY, KC_SLSH, COMBO_END};         // Using our custom dot keycode
...
// Initialize to enable debugging
void keyboard_post_init_user(void) {
    // Debug mode - enable to see debug info
    debug_enable = true;
    debug_matrix = true;
    debug_keyboard = true;
    
    // Flash the LEDs on init
