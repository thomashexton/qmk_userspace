 ...
 *  FIXED COMBOS
 *
 *  Instead of RCTL_T(KC_N) or RSFT_T(KC_E), we use plain KC_N, KC_E, etc.
 * ────────────────────────────────────────────────────────────────────────── */
...
const uint16_t PROGMEM equals_combo[]         = {KC_G, KC_M, COMBO_END};
const uint16_t PROGMEM under_combo[]         = {KC_D, KC_H, COMBO_END};

/* ────────────────────────────────────────────────────────────────────────── *
 *  COMBO ARRAY
 *
 *  We only list the combos we’re actually using. That means 7 combos total.
 * ────────────────────────────────────────────────────────────────────────── */
combo_t key_combos[] = {
